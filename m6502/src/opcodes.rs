...
pub fn resolve_opcode(n: u8) -> Option<Instruction> {
    match n {
        ...
        0x02 => None,
        0x03 => Some((Opcode::SLO, AddressingMode::IndirectX)),
        0x04 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPage)),
        0x05 => Some((Opcode::ORA, AddressingMode::ZeroPage)),
        0x06 => Some((Opcode::ASL, AddressingMode::ZeroPage)),
        0x07 => Some((Opcode::SLO, AddressingMode::ZeroPage)),
        ...
        0x0b => None,
        0x0c => Some((Opcode::UndocumentedNOP, AddressingMode::Absolute)),
        ...
        0x12 => None,
        0x13 => Some((Opcode::SLO, AddressingMode::IndirectY)),
        0x14 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0x15 => Some((Opcode::ORA, AddressingMode::ZeroPageX)),
        0x16 => Some((Opcode::ASL, AddressingMode::ZeroPageX)),
        0x17 => Some((Opcode::SLO, AddressingMode::ZeroPageX)),
        0x18 => Some((Opcode::CLC, AddressingMode::Implied)),
        0x19 => Some((Opcode::ORA, AddressingMode::AbsoluteY)),
        0x1a => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0x1b => Some((Opcode::SLO, AddressingMode::AbsoluteY)),
        0x1c => Some((Opcode::UndocumentedNOP, AddressingMode::Absolute)),
        0x1d => Some((Opcode::ORA, AddressingMode::AbsoluteX)),
        0x1e => Some((Opcode::ASL, AddressingMode::AbsoluteX)),
        0x1f => Some((Opcode::SLO, AddressingMode::AbsoluteX)),
        0x20 => Some((Opcode::JSR, AddressingMode::Absolute)),
        0x21 => Some((Opcode::AND, AddressingMode::IndirectX)),
        0x22 => None,
        0x23 => Some((Opcode::RLA, AddressingMode::IndirectX)),
        ...
        0x27 => Some((Opcode::RLA, AddressingMode::ZeroPage)),
        ...
        0x32 => None,
        0x33 => Some((Opcode::RLA, AddressingMode::IndirectY)),
        0x34 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0x35 => Some((Opcode::AND, AddressingMode::ZeroPageX)),
        0x36 => Some((Opcode::ROL, AddressingMode::ZeroPageX)),
        0x37 => Some((Opcode::RLA, AddressingMode::ZeroPageX)),
        0x38 => Some((Opcode::SEC, AddressingMode::Implied)),
        0x39 => Some((Opcode::AND, AddressingMode::AbsoluteY)),
        0x3a => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0x3b => Some((Opcode::RLA, AddressingMode::AbsoluteY)),
        0x3c => Some((Opcode::UndocumentedNOP, AddressingMode::AbsoluteX)),
        0x3d => Some((Opcode::AND, AddressingMode::AbsoluteX)),
        0x3e => Some((Opcode::ROL, AddressingMode::AbsoluteX)),
        0x3f => Some((Opcode::RLA, AddressingMode::AbsoluteX)),
        0x40 => Some((Opcode::RTI, AddressingMode::Implied)),
        0x41 => Some((Opcode::EOR, AddressingMode::IndirectX)),
        0x42 => None,
        0x43 => Some((Opcode::SRE, AddressingMode::IndirectX)),
        0x44 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPage)),
        0x45 => Some((Opcode::EOR, AddressingMode::ZeroPage)),
        0x46 => Some((Opcode::LSR, AddressingMode::ZeroPage)),
        0x47 => Some((Opcode::SRE, AddressingMode::ZeroPage)),
        ...
        0x52 => None,
        0x53 => Some((Opcode::SRE, AddressingMode::IndirectY)),
        0x54 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0x55 => Some((Opcode::EOR, AddressingMode::ZeroPageX)),
        0x56 => Some((Opcode::LSR, AddressingMode::ZeroPageX)),
        0x57 => Some((Opcode::SRE, AddressingMode::ZeroPageX)),
        0x58 => Some((Opcode::CLI, AddressingMode::Implied)),
        0x59 => Some((Opcode::EOR, AddressingMode::AbsoluteY)),
        0x5A => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0x5b => Some((Opcode::SRE, AddressingMode::AbsoluteY)),
        0x5c => Some((Opcode::UndocumentedNOP, AddressingMode::Absolute)),
        0x5d => Some((Opcode::EOR, AddressingMode::AbsoluteX)),
        0x5e => Some((Opcode::LSR, AddressingMode::AbsoluteX)),
        0x5f => Some((Opcode::SRE, AddressingMode::AbsoluteX)),
        0x60 => Some((Opcode::RTS, AddressingMode::Implied)),
        0x61 => Some((Opcode::ADC, AddressingMode::IndirectX)),
        0x62 => None,
        0x63 => Some((Opcode::RRA, AddressingMode::IndirectX)),
        0x64 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPage)),
        0x65 => Some((Opcode::ADC, AddressingMode::ZeroPage)),
        0x66 => Some((Opcode::ROR, AddressingMode::ZeroPage)),
        0x67 => Some((Opcode::RRA, AddressingMode::ZeroPage)),
        ...
        0x72 => None,
        0x73 => Some((Opcode::RRA, AddressingMode::IndirectY)),
        0x74 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0x75 => Some((Opcode::ADC, AddressingMode::ZeroPageX)),
        0x76 => Some((Opcode::ROR, AddressingMode::ZeroPageX)),
        0x77 => Some((Opcode::RRA, AddressingMode::ZeroPageX)),
        0x78 => Some((Opcode::SEI, AddressingMode::Implied)),
        0x79 => Some((Opcode::ADC, AddressingMode::AbsoluteY)),
        0x7A => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0x7b => Some((Opcode::RRA, AddressingMode::AbsoluteY)),
        0x7c => Some((Opcode::UndocumentedNOP, AddressingMode::AbsoluteX)),
        0x7d => Some((Opcode::ADC, AddressingMode::AbsoluteX)),
        0x7e => Some((Opcode::ROR, AddressingMode::AbsoluteX)),
        0x7f => Some((Opcode::RRA, AddressingMode::AbsoluteX)),
        0x80 => Some((Opcode::UndocumentedNOP, AddressingMode::Immediate)),
        0x81 => Some((Opcode::STA, AddressingMode::IndirectX)),
        0x82 => Some((Opcode::UndocumentedNOP, AddressingMode::Immediate)),
        0x83 => Some((Opcode::SAX, AddressingMode::IndirectX)),
        ...
        0x87 => Some((Opcode::SAX, AddressingMode::ZeroPage)),
        0x88 => Some((Opcode::DEY, AddressingMode::Implied)),
        0x89 => Some((Opcode::UndocumentedNOP, AddressingMode::Immediate)),
        ...
        0x97 => Some((Opcode::SAX, AddressingMode::ZeroPageY)),
        ...
        0xa3 => Some((Opcode::LAX, AddressingMode::IndirectX)),
        ...
        0xa7 => Some((Opcode::LAX, AddressingMode::ZeroPage)),
        ...
        0xb2 => None,
        0xb3 => Some((Opcode::LAX, AddressingMode::IndirectY)),
        ...
        0xb7 => Some((Opcode::LAX, AddressingMode::ZeroPageY)),
        ...
        0xbf => Some((Opcode::LAX, AddressingMode::AbsoluteY)),
        0xc0 => Some((Opcode::CPY, AddressingMode::Immediate)),
        0xc1 => Some((Opcode::CMP, AddressingMode::IndirectX)),
        0xc2 => Some((Opcode::UndocumentedNOP, AddressingMode::Immediate)),
        0xc3 => Some((Opcode::DCP, AddressingMode::IndirectX)),
        ...
        0xc7 => Some((Opcode::DCP, AddressingMode::ZeroPage)),
        ...
        0xd2 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0xd3 => Some((Opcode::DCP, AddressingMode::IndirectY)),
        0xd4 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0xd5 => Some((Opcode::CMP, AddressingMode::ZeroPageX)),
        0xd6 => Some((Opcode::DEC, AddressingMode::ZeroPageX)),
        0xd7 => Some((Opcode::DCP, AddressingMode::ZeroPageX)),
        0xd8 => Some((Opcode::CLD, AddressingMode::Implied)),
        0xd9 => Some((Opcode::CMP, AddressingMode::AbsoluteY)),
        0xda => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0xdb => Some((Opcode::DCP, AddressingMode::AbsoluteY)),
        0xdc => Some((Opcode::UndocumentedNOP, AddressingMode::AbsoluteX)),
        0xdd => Some((Opcode::CMP, AddressingMode::AbsoluteX)),
        0xde => Some((Opcode::DEC, AddressingMode::AbsoluteX)),
        0xdf => Some((Opcode::DCP, AddressingMode::AbsoluteX)),
        0xe0 => Some((Opcode::CPX, AddressingMode::Immediate)),
        0xe1 => Some((Opcode::SBC, AddressingMode::IndirectX)),
        0xe2 => Some((Opcode::UndocumentedNOP, AddressingMode::Immediate)),
        0xe3 => Some((Opcode::ISB, AddressingMode::IndirectX)),
        ...
        0xe7 => Some((Opcode::ISB, AddressingMode::ZeroPage)),
        ...
        0xeb => Some((Opcode::SBC, AddressingMode::Immediate)),
        ...
        0xef => Some((Opcode::ISB, AddressingMode::Absolute)),
        0xf0 => Some((Opcode::BEQ, AddressingMode::Relative)),
        0xf1 => Some((Opcode::SBC, AddressingMode::IndirectY)),
        0xf2 => None,
        0xf3 => Some((Opcode::ISB, AddressingMode::IndirectY)),
        0xf4 => Some((Opcode::UndocumentedNOP, AddressingMode::ZeroPageX)),
        0xf5 => Some((Opcode::SBC, AddressingMode::ZeroPageX)),
        0xf6 => Some((Opcode::INC, AddressingMode::ZeroPageX)),
        0xf7 => Some((Opcode::ISB, AddressingMode::ZeroPageX)),
        0xf8 => Some((Opcode::SED, AddressingMode::Implied)),
        0xf9 => Some((Opcode::SBC, AddressingMode::AbsoluteY)),
        0xfa => Some((Opcode::UndocumentedNOP, AddressingMode::Implied)),
        0xfb => Some((Opcode::ISB, AddressingMode::AbsoluteY)),
        0xfc => Some((Opcode::UndocumentedNOP, AddressingMode::AbsoluteX)),
        0xfd => Some((Opcode::SBC, AddressingMode::AbsoluteX)),
        0xfe => Some((Opcode::INC, AddressingMode::AbsoluteX)),
        0xff => Some((Opcode::ISB, AddressingMode::AbsoluteX)),
        _ => None,
    }
}
